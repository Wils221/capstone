    ...
    return (
        ...
        {plants.map((plantObj) => {
            ...
            <div className="plant-card" key={plantObj.id}>
                ...
                <div className="plant-name">Feeding Schedule: {plantObj.feedingSchedule}</div>
                <div className="plant-name">Sun Schedule: {plantObj.sunSchedule}</div>
                <div className="plant-name">Notes: {plantObj.notes}</div>

                <Link className="plant-edit" to={`/edit/${plantObj.id}`}>Edit</Link>
                <Link className="plant-delete">Delete</Link>
            </div>
            )
        })}
        </div>
